...
class ordenEjecusionTable extends ordenEjecusionBaseTable {
  ...
  public function save() {
    ...
    $params = array(
        ':ore_observacion' => $this->get(),
        ':ore_created_at' => $this->get(),
        ':ore_updated_at' => $this->get(),
        ':ore_deleted_at' => $this->get()
    );
    $answer = $conn->prepare($sql);
    $answer->execute($params);
//    return $conn->lastInsertId(self::_SEQUENCE);
  ...
  public function update() {
    $conn = $this->getConnection($this->config);
    $sql = 'UPDATE usuario SET ore_id = :ore_id, ter_id_elabora = :ter_id_elabora, ors_id = :ors_id, maq_id = :maq_id, ore_fecha = :ore_fecha, ore_observacion = :ore_observacion, ore_create_at = :ore_create_at, ore_update_at = :ore_update_at, ore_deleted_at = :ore_deleted_at  WHERE id = :ore_id';
    $params = array(
        ':ore_observacion' => $this->get(),
        ':ore_created_at' => $this->get(),
        ':ore_updated_at' => $this->get(),
  ...
  public function delete() {
    $conn = $this->getConnection($this->config);
    $sql = 'DELETE FROM orderEjecucion WHERE id = :ore_id';
    $params = array(
        ':ore_id' => $this->getId()
    );
