...
/**
 * Description of detalleEntradaSalidaBodegaTableBase
 ...
 * @version 1.0.0
 */
class detalleEntradaSalidaBodegaTableBase extends model {
  ...
  /**
   * Constructor de la clase detalleEntradaSalidaBodegaTableBase
   * @version 1.0.0
   * @param config $config
   * @param integer $id
   * @param integer $id2
