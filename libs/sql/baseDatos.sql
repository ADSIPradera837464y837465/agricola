...
(
	bit_id BIGINT DEFAULT nextval('bda_bitacora_bit_id_seq'::regclass) NOT NULL,
...
(
	car_id BIGINT DEFAULT nextval('bda_cargo_car_id_seq'::regclass) NOT NULL,
...
(
	crp_id BIGINT DEFAULT nextval('bda_contro_riego_pluviosidad_crp_id_seq'::regclass) NOT NULL,
...
(
	csc_id BIGINT DEFAULT nextval('bda_control_salida_cana_csc_id_seq'::regclass) NOT NULL,
...
(
	dus_id BIGINT DEFAULT nextval('bda_dato_usuario_dus_id_seq'::regclass) NOT NULL,
	usr_id BIGINT NOT NULL,
...
(
	deaas_id BIGINT DEFAULT nextval('bda_detalle_agua_surco_deaas_id_seq'::regclass) NOT NULL,
...
(
	decs_id BIGINT DEFAULT nextval('bda_detalle_caudal_surco_decs_id_seq'::regclass) NOT NULL,
...
(
	dee_id BIGINT DEFAULT nextval('bda_detalle_ejecucion_dee_id_seq'::regclass) NOT NULL,
...
(
	des_id BIGINT DEFAULT nextval('bda_detalle_entrada_salida_bodega_des_id_seq'::regclass) NOT NULL,
...
(
	deo_id BIGINT DEFAULT nextval('bda_detalle_orden_deo_id_seq'::regclass) NOT NULL,
...
(
	der_item BIGINT DEFAULT nextval('bda_detalle_registro_der_item_seq'::regclass) NOT NULL,
...
(
	esb_id BIGINT DEFAULT nextval('bda_entrada_salida_bodega_esb_id_seq'::regclass) NOT NULL,
...
(
	fore_num_documento BIGINT DEFAULT nextval('bda_formulario_registro_fore_num_documento_seq'::regclass) NOT NULL,
...
(
	hac_id BIGINT DEFAULT nextval('bda_hacienda_hac_id_seq'::regclass) NOT NULL,
...
(
	imp_id BIGINT DEFAULT nextval('bda_implemento_imp_id_seq'::regclass) NOT NULL,
...
(
	inv_id BIGINT DEFAULT nextval('bda_inventario_inv_id_seq'::regclass) NOT NULL,
	des_id BIGINT NOT NULL,
	pro_id BIGINT NOT NULL,
	tpd_id BIGINT NOT NULL,
	inv_fech DATE NOT NULL,
...
(
	lab_id BIGINT DEFAULT nextval('bda_labor_lab_id_seq'::regclass) NOT NULL,
...
(
	maq_id BIGINT DEFAULT nextval('bda_maquina_maq_id_seq'::regclass) NOT NULL,
	...
	maq_t_accesorio VARCHAR(80) NOT NULL,
...
(
	mar_id BIGINT DEFAULT nextval('bda_marca_mar_id_seq'::regclass) NOT NULL,
...
(
	met_rie_id BIGINT DEFAULT nextval('bda_metodo_riego_met_rie_id_seq'::regclass) NOT NULL,
...
(
	ore_id BIGINT DEFAULT nextval('bda_orden_ejecucion_ore_id_seq'::regclass) NOT NULL,
	ter_id_elabora BIGINT NOT NULL,
	ors_id BIGINT NOT NULL,
	maq_id BIGINT NOT NULL,
...
(
	ors_id BIGINT DEFAULT nextval('bda_orden_servicio_ors_id_seq'::regclass) NOT NULL,
	maq_id BIGINT NOT NULL,
...
(
	pro_id BIGINT DEFAULT nextval('bda_producto_pro_id_seq'::regclass) NOT NULL,
...
(
	rcm_id BIGINT DEFAULT nextval('bda_recordar_me_rcm_id_seq'::regclass) NOT NULL,
...
(
	relme_numero BIGINT DEFAULT nextval('bda_registro_labores_maquina_equipo_relme_numero_seq'::regclass) NOT NULL,
	hac_id BIGINT NOT NULL,
	ter_id BIGINT NOT NULL,
	tpd_id BIGINT NOT NULL,
...
(
	rt_item BIGINT DEFAULT nextval('bda_registro_tractor_rt_item_seq'::regclass) NOT NULL,
...
(
	rol_id BIGINT DEFAULT nextval('bda_rol_rol_id_seq'::regclass) NOT NULL,
...
(
	ser_id BIGINT DEFAULT nextval('bda_servicio_maquina_ser_id_seq'::regclass) NOT NULL,
...
(
	sie_id BIGINT DEFAULT nextval('bda_siembra_sie_id_seq'::regclass) NOT NULL,
	sue_id BIGINT NOT NULL,
...
(
	sue_id BIGINT DEFAULT nextval('bda_suerte_sue_id_seq'::regclass) NOT NULL,
...
(
	ter_id BIGINT DEFAULT nextval('bda_tercero_ter_id_seq'::regclass) NOT NULL,
...
(
	tpd_id BIGINT DEFAULT nextval('bda_tipo_documento_tpd_id_seq'::regclass) NOT NULL,
...
(
	tpi_id BIGINT DEFAULT nextval('bda_tipo_id_tpi_id_seq'::regclass) NOT NULL,
...
(
	tma_id BIGINT DEFAULT nextval('bda_tipo_mantenimiento_tma_id_seq'::regclass) NOT NULL,
...
(
	tpr_id BIGINT DEFAULT nextval('bda_tipo_producto_tpr_id_seq'::regclass) NOT NULL,
...
(
	tis_id BIGINT DEFAULT nextval('bda_tipo_suelo_tis_id_seq'::regclass) NOT NULL,
...
(
	tit_id BIGINT DEFAULT nextval('bda_tipo_tercero_tit_id_seq'::regclass) NOT NULL,
...
(
	tur_id BIGINT DEFAULT nextval('bda_turno_tur_id_seq'::regclass) NOT NULL,
...
(
	unm_id BIGINT DEFAULT nextval('bda_unidad_medida_unm_id_seq'::regclass) NOT NULL,
...
(
	usr_id BIGINT DEFAULT nextval('bda_usuario_usr_id_seq'::regclass) NOT NULL,
...
(
	url_id BIGINT DEFAULT nextval('bda_usuario_rol_url_id_seq'::regclass) NOT NULL,
...
ALTER TABLE public.bda_detalle_registro ADD CONSTRAINT fk_bda_detalle_registro_bda_registro_labores_maquina_equipo
	FOREIGN KEY (relme_numero) REFERENCES public.bda_registro_labores_maquina_equipo (relme_numero)
	ON UPDATE RESTRICT ON DELETE RESTRICT;
...
/* Add Foreign Key: fk_bda_inventario_bda_detalle_entrada_salida_bodega */
ALTER TABLE public.bda_inventario ADD CONSTRAINT fk_bda_inventario_bda_detalle_entrada_salida_bodega
	FOREIGN KEY (des_id) REFERENCES public.bda_detalle_entrada_salida_bodega (des_id)
	ON UPDATE RESTRICT ON DELETE RESTRICT;
